...
$routes->put('provinsi/update/(:num)', 'ProvinsiController::update/$1');
$routes->delete('provinsi/delete/(:num)', 'ProvinsiController::delete/$1');
$routes->post('apilogin', 'AuthController::apiLogin');